        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                ...
                <span className="font-heading text-xs text-primary-300 block -mt-1">Academy</span>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <a
                href="tel:0852401266"
                className="flex items-center gap-3 text-gray-400 hover:text-primary-300 transition-colors text-sm"
              >
