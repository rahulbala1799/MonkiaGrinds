...
export default function ContactPage() {
  ...
  if (submitted) {
    return (
      <div className="min-h-screen flex items-center justify-center px-4 pt-32 bg-gray-50">
        <motion.div
  ...
  return (
    <>
      {/* Header */}
      <section className="gradient-hero pt-40 md:pt-44 pb-20 px-4 relative overflow-hidden">
