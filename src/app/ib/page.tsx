...
export default function IBPage() {
  return (
    <SubjectPageLayout
      ...
      heroDescription="Specialised support for IB students with concept-driven learning, exam preparation, and personalised classes tailored to the IB syllabus."
